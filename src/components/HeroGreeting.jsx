...
const HeroGreeting = ({ onNavigate }) => {
  ...
  return (
    <section className="flex flex-col justify-center pt-16 pb-40 md:pt-6 md:pb-24 w-full relative overflow-hidden">
      ...
      <div className="w-full max-w-5xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-24 md:gap-20 lg:gap-24">
          ...
          <div className="flex flex-col items-center md:items-start justify-start md:justify-start text-center md:text-left w-full md:w-auto flex-1 max-w-[500px] min-h-[100vh] md:min-h-0 pt-[18vh] md:pt-4 pb-12 md:pb-0">
