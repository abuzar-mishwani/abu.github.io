...
const chapters = [
  ...
  },
  {
    ...
    content: (
      <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
        ...
        <p>
          The Quran is my ultimate guide. There is one verse that is very close to my heart and always gives me strength in difficult times:
        </p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
        ...
        <p>
          That single decision changed my life. I still remember those early days. My small hands struggled to type on the keyboard, and I used to get excited every time I learned something new in <span className="font-semibold text-foreground">MS Word or Excel</span>. After a few months, I received my first computer certificate, and it felt like a big achievement.
        </p>
        <p>
          Not long after, my father bought me my first computer, an <span className="font-semibold text-foreground">old Pentium 2</span>. At that age, I only used it to play games. But as I grew older, my curiosity grew with me. In <span className="font-semibold text-foreground">2016</span>, after many requests, I finally got my first <span className="font-semibold text-foreground">smartphone</span>. That was when everything changed.
        </p>
        <p>
          With that phone came <span className="font-semibold text-foreground">internet access</span>, and I wanted to connect it to my computer. I soon found out I needed a <span className="font-semibold text-foreground">Wi-Fi adapter</span>, which cost around Rs. 800, but my pocket money was only Rs. 10 a day. I didn't want to bother my father, so when my elder sister came home, I shared my wish with her. Without a second thought, she gave me Rs. 1000.
        </p>
        <p>
          That day felt magical. I bought the adapter, connected to the internet, and for the first time, I opened <span className="font-semibold text-foreground">Google</span> on my computer. I still remember the feeling. I sat back and said to myself, "Now the world is in front of me. <span className="font-semibold text-foreground">Google is mine</span>."
        </p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
        <p>
          Once I had <span className="font-semibold text-foreground">internet</span>, I spent hours exploring. At first, I didn't even know what to search for. I would sit there thinking, "What should I learn today?"
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
        <p>
          I completed my <span className="font-semibold text-foreground">matriculation from Drosh Public School and College</span>, and later did my <span className="font-semibold text-foreground">ICS (Intermediate in Computer Science) from Government Higher Secondary School Drosh</span>.
        </p>
        <p>
          After that, I joined the <span className="font-semibold text-foreground">University of Chitral</span> for my <span className="font-semibold text-foreground">BS in Computer Science</span>, which I completed in <span className="font-semibold text-foreground">December 2024</span>.
        </p>
        <p>
          I am now pursuing my <span className="font-semibold text-foreground">MPhil in Computer Science</span> and plan to complete my PhD before turning 30, InshaAllah.
        </p>
      </div>
    ),
  },
  {
    ...
    title: "Freelancing & First Earnings",
    content: (
      <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
        <p>
          My freelancing journey began while I was doing my ICS. It started when I realized that the skills I was learning could actually help others. I began offering small services like <span className="font-semibold text-foreground">creating WordPress websites, doing SEO, and writing content</span>.
        </p>
        <p>
          I still remember the day I received my <span className="font-semibold text-foreground">first payment</span>. It was not a big amount, but it felt like I had conquered the world. Earning money for the first time through something I built on my own was an unforgettable moment. That day, I realized that with knowledge and determination, you can create your own opportunities.
        </p>
        <p>
          Freelancing gave me <span className="font-semibold text-foreground">independence, confidence, and direction</span>. It taught me how to manage clients, work with deadlines, and most importantly, trust my own skills.
        </p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
        ...
        <p>
          In <span className="font-semibold text-foreground">2022</span>, I launched <a href="https://app.techabu.co" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-500 hover:underline">Spot Web Tools</a>, an online platform offering over <span className="font-semibold text-foreground">190 free SEO and web tools</span> used by developers, students, and marketers around the world. I also developed its Android app to make it more accessible.
        </p>
        <p>
          In <span className="font-semibold text-foreground">2023</span>, I created the <a href="https://play.google.com/store/apps/details?id=advc.calc.easygpacalculator" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-500 hover:underline">GPA Calculator & Planner</a> app for students to calculate and plan their semester performance easily. Seeing students benefit from my app was deeply fulfilling. It reminded me that technology, when built with purpose, can truly make people's lives easier.
        </p>
        <p>
          As a software engineer, I have developed many <span className="font-semibold text-foreground">AI-powered tools and platforms</span> that simplify tasks and improve workflows. Under HindukushSoft Technologies, I also built a SaaS platform to automate business operations in Chitral and help local businesses transition to technology.
        </p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
        <p>
          After graduation, I joined <span className="font-semibold text-foreground">SoftLixx Technologies Pvt. Ltd.</span> as a <span className="font-semibold text-foreground">Web Developer</span>, where I worked on real-world projects and gained hands-on experience in professional software development. This role helped me understand industry standards, teamwork, and how to deliver production-level software.
        </p>
        <p>
          Alongside my professional career, I have been working with <span className="font-semibold text-foreground">Accelerate Prosperity</span> as an entrepreneur, learning, growing, and contributing to building the startup ecosystem in Chitral.
        </p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
        ...
        <p>
          HindukushSoft was built with a vision to <span className="font-semibold text-foreground">create IT jobs, train young minds, and bring digital innovation to Chitral</span>.
        </p>
        <p>
          We also introduced the <span className="font-semibold text-foreground">first paid internship program in Chitral</span> through the <span className="font-semibold text-foreground">PSEB Skill Bridge Apprenticeship Program</span>, a government-backed initiative by the Pakistan Software Export Board (PSEB) under the Ministry of IT and Telecom. This program allows students to gain professional skills, real-world experience, and earn a monthly stipend while contributing to meaningful projects.
        </p>
        <p>
          HindukushSoft also focuses on <span className="font-semibold text-foreground">SaaS platforms, AI-powered applications, and automation solutions</span> to help businesses transition into technology. We aim to create awareness of technology, provide skill development opportunities, and ensure that Chitral's youth are not left behind in the global digital economy.
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
        <p>
          Giving back to my community has always been close to my heart. I have volunteered with <span className="font-semibold text-foreground">Al-Khidmat Foundation Chitral</span>, helping them with <span className="font-semibold text-foreground">IT support and digital systems</span>. I have also taught <span className="font-semibold text-foreground">computer science</span> voluntarily at local academies to inspire students and help them build careers in technology.
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
        <p>
          I started my programming journey with <span className="font-semibold text-foreground">HTML, CSS, and JavaScript</span>, and later explored backend technologies like <span className="font-semibold text-foreground">PHP, Laravel, Node.js, and Express</span>. Today, I work with modern web technologies such as <span className="font-semibold text-foreground">React, TypeScript, Next.js, and Laravel</span>, among others, to build fast and interactive applications.
        </p>
        <p>
          I am also highly skilled in <span className="font-semibold text-foreground">WordPress development and SEO</span>, having helped numerous clients improve their websites and online presence. In addition, I have developed <span className="font-semibold text-foreground">AI-powered tools and SaaS platforms</span> to automate tasks and support businesses.
        </p>
        <p>
          Beyond coding, I possess strong <span className="font-semibold text-foreground">logical, analytical, and problem-solving skills</span>, which allow me to tackle complex challenges effectively and create solutions that are both practical and impactful.
        </p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
        <p>
          Outside of work, I have always loved <span className="font-semibold text-foreground">cricket</span>. I used to be a proper cricketer, a good batsman, and a part-time bowler. After completing my ICS, I had to quit cricket to focus on my studies, but the passion for the game still lives in me.
        </p>
        <p>
          Between 2010 and 2016, I was also a dedicated gamer, playing almost every popular computer game of that time, including <span className="font-semibold text-foreground">GTA V, Max Payne 3, Call of Duty</span>, among others. Those years as a gamer improved my focus, problem-solving, and creativity.
        </p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
        ...
        <p>
          My mission in life is to <span className="font-semibold text-foreground">make life easier for others, to help people, and to create opportunities</span> wherever I can. I believe that success only has meaning when it benefits others.
        </p>
        <p>
      ...
      <div className="w-full max-w-5xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="text-center md:text-left mb-16 md:mb-24">
          ...
          >
            ...
            <h2 className="text-5xl md:text-7xl font-extrabold text-foreground tracking-tighter mb-8 leading-[1.1] relative">
